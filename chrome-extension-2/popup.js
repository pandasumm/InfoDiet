...
function addLocalDisplay() {
    ...
    var relativePct = 0;
    for (var index = 0;
        ((index < sortedSites.length) && (index < max)); index++) {
        ...
        // if (categorizer.hasOwnProperty(site)){
        //     console.log("site in categories")
        //     linkText = document.createTextNode(categorizer[site]);
        // }
